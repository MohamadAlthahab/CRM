...
import { CreateCustomerAddress } from '../interface/CreateCustomerAddress';


export default function CreateCustomerDialog() {
    const [openCustomerDialog, setOpenCustomerDialog] = React.useState(false);
    const [customerData, setCreateCustomerParams] = React.useState<Customer>({
        CustomerCode: '',
        FirstName: '',
        LastName: '',
        Email: '',
    ...
    const [addressData, setAddressData] = React.useState<CreateCustomerAddress>({
        Address1: '',
        Address2: '',
        City: '',
